        ...
        <div class="container-fluid row">
            ...
            <div class="col-8 bg-pale mb-2 p-3 rounded">
                ...
                <div class="mb-3 d-flex justify-content-between">
                    <span class="fs-5">100 Friends</span>
					<div class="search-bar">
						<input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Find friends">
						<span class="close pointer"> <i
							class="bi bi-x fs-4 pointer"></i>
						</span>
					</div>
				</div>
                
                <div class="profile-info border rounded d-flex justify-content-between">
                ...
                <div class="profile-info border rounded d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="profile-name">
                            <b>Malar</b><br> 
                            <small class="text-muted">10 mutual friends</small>
                        </div>
                    </div>
                    <div>
                        <button type="button" class="btn btn-primary">View Profile</button>
                ...
                <div class="profile-info border rounded d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="profile-name">
                            <b>Thura</b><br> 
                            <small class="text-muted">20 mutual friends</small>
                        </div>
                    </div>
                    <div>
                        <button type="button" class="btn btn-primary">View Profile</button>
                ...
                <div class="profile-info border rounded d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="profile-name">
                            <b>Kyaw Swar</b><br> 
                            <small class="text-muted">15 mutual friends</small>
                        </div>
                    </div>
                    <div>
                        <button type="button" class="btn btn-primary">View Profile</button>
                ...
                <div class="profile-info border rounded d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="profile-name">
                            <b>Zar Ni</b><br> 
                            <small class="text-muted">33 mutual friends</small>
                        </div>
                    </div>
                    <div>
                        <button type="button" class="btn btn-primary">View Profile</button>
