<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="bg-pale mb-2 p-3 rounded">
	<div class="mb-3 d-flex justify-content-between">
		<span class="fs-5">Friends (10)</span> <a href="#"
			class="btn btn-purple"> <i class="bi-search"></i> Find a friend 
		</a>
	</div>

	<div class="row row-cols-2 row-cols-md-4 g-3">
		<div class="col pointer">
			<div class="border rounded text-center friend-card">
				<img
		...
		<div class="col d-flex justify-content-center my-auto">
			<a href=""
				class="d-flex purple flex-column text-decoration-none align-items-center">
