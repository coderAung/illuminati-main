...
<c:url var="aboutus" value="/view/aboutus.jsp"></c:url>
...
<c:url var="bootstrap"
	value="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css"></c:url>
<c:url var="js"
...
<body>
	<footer>
		<div class="footer-container">
			...
			<div class="footer-section">
				<h3>About Us</h3>
				<p>We strive to bring people together and foster meaningful
					connections.</p>
				<p>Contact Us</p>
				<p>
		...
		<div class="footer-bottom">
			<div class="social-icons">
				...
				</a> <a href="#" style="color: #C13584;"> <svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
